    ...
    <footer className="noise-texture bg-[#141414] relative" role="contentinfo">
      ...
      <div className="py-20 md:py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-[2fr_1fr_1fr] gap-12 md:gap-16">
            {/* Column 1: Brand */}
            <div>
              <p className="text-xl text-white font-[family-name:var(--font-display)]">
            ...
            <div>
              ...
              <a
                ...
                className="text-[#8A8A8A] text-sm hover:text-[#0A8FBF] transition-colors duration-200"
              >
          ...
          <div className="mt-16 border-t border-white/5 pt-8 flex items-center justify-between">
            <p className="text-xs text-[#8A8A8A]/60">
              &copy; 2024 Origami Digital. All rights reserved.
            </p>
            <a
              href="#"
